...
export default function Home(){
  return (
    <div>
      <span className='absolute z-10 pt-44 pl-8'>
        <p className='font-bold text-[3.0rem]'>Bem-vindo(a).</p>
        <p className='font-bold text-3xl'>Milhões de filmes, series e pessoas para descobrir. Explore ja</p>
        <form className='h-12 w-[1200px] mt-5 bg-white flex justify-between items-center rounded-3xl pl-1'>
          <input 
          type="text" 
      ...
      <div className='h-screen w-full z-20 pl-8 absolute bg-white mt-96 flex flex-col'>
        ...
        <div className='flex justify-center gap-5 pr-10'>
      ...
      <img src={avengersWallpaper} alt="avengersWallpaper" className='saturate-[.2] z-0'/>
    </div>
  )
}